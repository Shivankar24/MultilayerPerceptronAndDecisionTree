...
def graph1(root,coord,i):
	...
	if(root.left!=None and root.right!=None and root.attributeindex==0):
		...
		g1.plot([newcoord[0]+newcoord[2],newcoord[0]+newcoord[2]],[newcoord[1],abs(newcoord[1]-newcoord[3])])
		#g1.show()
	...
	if(root.left!=None and root.right!=None and root.attributeindex==1):
		...
		g1.plot([newcoord[0],newcoord[0]+newcoord[2]],[abs(newcoord[1]-newcoord[3]),abs(newcoord[1]-newcoord[3])])
		#g1.show()
		graph1(root.left,newcoord,i)
		newcoord1=[newcoord[0],abs(newcoord[1]-newcoord[3]),newcoord[2],abs(coord[3]-newcoord[3])]
		graph1(root.right,newcoord1,i)
def points():
	ppoints1x=[]
	ppoints1y=[]
